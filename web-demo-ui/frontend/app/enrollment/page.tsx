...
export default function CreatorEnrollment() {
  ...
  useEffect(() => {
    ...
    console.log('[ENROLLMENT] Video ref:', !!videoRef.current, 'srcObject:', !!videoRef.current?.srcObject)
  ...
  useEffect(() => {
    const checkVideoReady = () => {
      ...
      console.log('[ENROLLMENT] roomId:', roomId, 'video ref:', !!videoRef.current, 'srcObject:', !!videoRef.current?.srcObject)
      
      if (roomId && videoRef.current && videoRef.current.srcObject) {
        console.log('[ENROLLMENT] Video stream is ready, starting face detection')
        startLiveFaceDetection()
        return true
      }
      return false
  ...
  const startLiveFaceDetection = () => {
    ...
    detectionIntervalRef.current = setInterval(() => {
      ...
      if (roomId && roomId.length > 0) {
        console.log('[ENROLLMENT] Attempting to capture frame, roomId:', roomId)
        ...
        console.log('[ENROLLMENT] Waiting for room ID to be generated...', 'roomId:', roomId)
      }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">
            Position your face in the camera view and click "Enroll Face" to proceed to streaming
          </p>
          {roomId && <p className="text-sm text-gray-500 mt-2">Room ID: {roomId}</p>}
        </div>
          ...
          <div className="space-y-4">
              ...
              {isEnrolling && (
                <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center rounded-lg">
                  <div className="bg-white text-black p-4 rounded-lg text-center max-w-xs mx-4 shadow-lg">
                    <div className="text-base font-semibold mb-3">Enrolling Face...</div>
            ...
            {detectedFaces.length > 0 && !isEnrolling && (
              <div className="bg-gray-800 p-4 rounded-lg">
                <h3 className="text-lg font-semibold mb-2 text-green-400">Face Detection Active</h3>
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              ...
              {!enrollmentComplete ? (
                <>
                  <div className="space-y-4 mb-6">
                    <p className="text-gray-300">
                      Make sure your face is clearly visible and well-lit before enrolling.
                    </p>
                ...
                <div className="text-center space-y-4">
                  ...
                  <h3 className="text-xl font-semibold text-green-400">Enrollment Complete!</h3>
                  <p className="text-gray-300">
                    Your face has been successfully enrolled for this streaming session.
                  </p>
